import{app,doc,createUserWithEmailAndPassword,signInWithEmailAndPassword,setDoc,getDoc,auth,db} from "./firebase.js"
...
const loginHandle = async () =>{
    ...
    try {
        ...
        const response = await signInWithEmailAndPassword(auth,email.value,pass.value)
